...
?>
            <div class="wt-migrator-cloud-storage-info child-form-item child-wt_mgdb_import_option wt_mgdb_import_option_s3bucket" style="display:none">
                ...
                <table class="wf-form-table wt_mgdp_import_options " style="max-width:650px;">
                    <tbody>
                        <tr>
                            <th style="font-weight: 400"><?php esc_html_e('Enable Amazon S3', 'wp-migration-duplicator') ?></th>
                            <td>
                        ...
                        <tr>
                            <th style="font-weight: 400">
                                <?php esc_html_e('Amazon S3 File Name', 'wp-migration-duplicator') ?>
                                <span class="wt-mgdp-tootip" data-wt-mgdp-tooltip="<?php esc_attr_e('The exact file name of the backup file to import', 'wp-migration-duplicator'); ?>"><span class="wt-mgdp-tootip-icon"></span></span>
                            </th>
                            <td>
            ...
            <div class="wt-migrator-cloud-storage-info child-form-item child-wt_mgdb_export_option wt_mgdb_export_option_s3bucket time_class" style="display:none">
                ...
                <table class="wf-form-table" style="max-width:650px;">
                    <tbody>
                        ...
                        <tr>
                            <th style="font-weight: 400">
                                <?php esc_html_e('Export Filename', 'wp-migration-duplicator') ?>
                                <span class="wt-mgdp-tootip" data-wt-mgdp-tooltip="<?php esc_attr_e('Allows to add a custom name to the backup file, leave it blank if you want the plugin to define the name for your backup file.', 'wp-migration-duplicator'); ?>"><span class="wt-mgdp-tootip-icon"></span></span>
                            </th>
                            <td>
        ...
        ?>
            <div class="wt-migrator-cloud-storage-info child-form-item child-wt_mgdb_export_option wt_mgdb_export_option_s3bucket_schedule time_class" style="display:none">
                ...
                <table class="wf-form-table" style="max-width:650px;">
                    <tbody>
                        <tr>
                            <th><?php esc_html_e('Enable Amazon S3', 'wp-migration-duplicator') ?></th>
                            <td>
                            <span class="wt-cli-cloud-status wt-cli-cloud-status-enabled" style="margin-left: 20px;">
                                <span class="dashicons dashicons-saved"></span><?php esc_html_e('(Enabled)','wp-migration-duplicator');?>
                            </span>
