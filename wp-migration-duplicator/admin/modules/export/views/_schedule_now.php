...
<div class="wt_mgdp_schedule_now wt_mgdp_cron_popup">
    <div class="wt_mgdp_cron_popup_new">
        ...
        <div class = "popup_second popup_common">
            ...
            <button name="wt_mgdp_export_stop_btn" class="button button-secondary" style="margin: 100px 0px 10px 250px;font-size: 16px;"><?php esc_html_e('Stop export', 'wp-migration-duplicator'); ?></button>
